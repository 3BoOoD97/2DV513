...
CREATE TABLE `writes` (
  ...
  KEY `isbn_idx` (`isbn`),
  CONSTRAINT `auth_id` FOREIGN KEY (`auth_id`) REFERENCES `author` (`auth_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `writes` VALUES (19,'566-98-440'),(20,'566-98-440');
